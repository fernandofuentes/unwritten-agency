...
import logoUrl from '../assets/unwritten-digital-marketing-agency-logo.svg?url';
    ...
    <header className="bg-white dark:bg-gray-900">
      ...
      >
        ...
        <a href="#" className="-m-1.5 p-1.5">
          <span className="sr-only">Unwritten Agency</span>
          {/* ✅ Use the imported URL */}
          <img src={logoUrl} alt="Unwritten Agency" className="h-8 w-auto" height={50} />
        </a>
